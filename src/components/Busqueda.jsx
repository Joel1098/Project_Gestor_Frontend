/*
Funcionalidad: Componente de búsqueda que permite al usuario buscar proyectos.
Entradas: Ninguna.
Salidas: Renderiza una interfaz de búsqueda que muestra proyectos filtrados en tiempo real a medida que el usuario escribe en el campo de búsqueda. Al hacer clic en un proyecto, redirige al usuario a la página de ese proyecto.
Comportamientos:
- Filtrar proyectos en tiempo real mientras el usuario escribe en el campo de búsqueda.
- Redirige al usuario a la página del proyecto al hacer clic en un proyecto de la lista.
*/
...
const Busqueda = () => {
    ...
    // Filtrar proyectos en base a la búsqueda del usuario
